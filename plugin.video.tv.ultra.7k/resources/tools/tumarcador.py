...
parser="[COLOR skyblue][B]Canales TuMarcador  [COLOR orange]Agenda Incluida [COLOR skyblue][/B][/COLOR]"
autor="[COLOR yellow][B][I]Exclusivex PM[/I][/B][/COLOR]"
...
def tumarcador0(params):
	...
	plugintools.add_item(action="zap_marcador",url="",title="[COLOR white][B]- Todos los Canales -[/COLOR][/B]",thumbnail="https://dl.dropbox.com/s/m3ef0irmyqb0b6k/tv%20ultra%20logo%202.png?dl=0",fanart=fondo,folder=True,isPlayable=False)
