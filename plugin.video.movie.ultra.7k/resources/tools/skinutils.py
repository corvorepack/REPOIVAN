...
def xml_skin():
    ...
    # values="Premium|Movie Ultra 7K Team|Latino Total|PLD|T-Killa|Pastebin|Personalizado|Halloween"
    if xmlmaster == 'true':
        if SelectXMLmenu == '0':  # Movie Ultra 7K Team
            mastermenu = 'http://pastebin.com/raw.php?i=YhCRzk9C'
            plugintools.log("[movie.ultra.7k.xml_skin: "+SelectXMLmenu)
            # Control para ver la intro de Movie Ultra 7K
            ...
            mastermenu = 'http://pastebin.com/raw.php?i=YhCRzk9C'
            if mastermenu == "":
                plugintools.log("[movie.ultra.7k.xml_skin: No definido")
                mastermenu = 'http://pastebin.com/raw.php?i=YhCRzk9C'
                # Control para ver la intro de Movie Ultra 7K
                ver_intro = plugintools.get_setting("ver_intro")
                if ver_intro == "true":
            ...
            if id_pastebin == "":
                ...
                plugintools.log("[movie.ultra.7k.xml_skin: "+mastermenu)
