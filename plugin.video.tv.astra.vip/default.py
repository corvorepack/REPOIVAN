...
__art__ = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.tv.ultra.7k/art', ''))
__cbx_pages__ = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.tv.ultra.7k/art/cbx', ''))
__icons__ = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.tv.ultra.7k/art/icons', ''))
__libdir__ = xbmc.translatePath(os.path.join('special://xbmc/system/players/dvdplayer/', ''))
__tools__ = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.tv.ultra.7k/resources/tools', ''))
__addons__ = xbmc.translatePath(os.path.join('special://home/addons/', ''))
__resources__ = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.tv.ultra.7k/resources', ''))
...
# Punto de entrada
def run():
    plugintools.log('[%s %s] ---> tv.ultra.7k.run <--- ' % (addonName, addonVersion))
...
def main_list(params):
    ...
    # Control del skin de TV Ultra 7K
    ...
    try:
        ...
        data = plugintools.read(mastermenu)
        xbmc.executebuiltin("Notification(%s,%s,%i,%s)" % ('TV Ultra 7K', "XML no reconocido...", 3 , __art__+'icon.png'))
        ...
        if data.startswith("#EXTINF:-1") == True:
           ...
           # Control para determinadas listas de decos sat
            ...
            if data != "":  # Iniciamos análisis de la URL...
                #plugintools.log("Analizando URL... "+str(i))
                url = data.strip()
            ...
            if data != "":
                ...
                if url == "#multi" or url == "#multilink":
                    ...
                    if cat == "":
                        ...
                        if url.find("seriesadicto") >= 0:
                            plugintools.add_item( action = "seriecatcher" , title = '[COLOR white]' + title + ' [COLOR lightgreen][B][Series[/B]adicto][/COLOR]', url = url , thumbnail = thumbnail, fanart = fanart , info_labels = datamovie, folder = True , isPlayable = False )
                            data = file.readline()
                            i = i + 1
                            continue
                        elif url.find("seriesflv") >= 0:
                            plugintools.add_item( action = "lista_capis" , title = '[COLOR white]' + title + ' [COLOR lightgreen][B][Series[/B]FLV][/COLOR]', url = url , thumbnail = thumbnail, fanart = fanart , info_labels = datamovie, folder = True , isPlayable = False )
                            data = file.readline()
                            i = i + 1
                            continue
                        elif url.find("seriesyonkis") >= 0:
                            plugintools.add_item( action = "serie_capis" , title = '[COLOR white]' + title + ' [COLOR lightgreen][B][Series[/B]Yonkis][/COLOR]', url = url , thumbnail = thumbnail, fanart = fanart , info_labels = datamovie, folder = True , isPlayable = False )
                            data = file.readline()
                            i = i + 1
                            continue
                        elif url.find("seriesblanco") >= 0:
                            plugintools.add_item( action = "seriesblanco0" , title = '[COLOR white]' + title + ' [COLOR lightgreen][B][Series[/B]Blanco][/COLOR]', url = url , thumbnail = thumbnail, fanart = fanart , info_labels = datamovie, folder = True , isPlayable = False )
                            data = file.readline()
                            i = i + 1
                            continue
                        elif url.find("series.mu") >= 0:
                            plugintools.add_item( action = "seriesmu0" , title = '[COLOR white]' + title + ' [COLOR lightgreen][B][Series[/B].Mu][/COLOR]', url = url , thumbnail = thumbnail, fanart = fanart , info_labels = datamovie, folder = True , isPlayable = False )
                            data = file.readline()
                            i = i + 1
                            continue
                    ...
                    if cat == "":                                                 
                        ...
                        if url.find("pelisadicto") >= 0:
                            plugintools.add_item( action = "seriecatcher" , title = '[COLOR white]' + title + ' [COLOR lightgreen][B][Pelis[/B]adicto][/COLOR][COLOR white][I] (' + origen + ')[/I][/COLOR]', url = url, thumbnail = thumbnail, fanart = fanart , folder = True , isPlayable = False )
                            data = file.readline()
                            i = i + 1
                            continue
                        elif url.find("oranline") >= 0:
                            plugintools.add_item( action = "oranline0" , title = '[COLOR white]' + title + ' [COLOR lightgreen][Oranline][/COLOR]', url = url , thumbnail = thumbnail, fanart = fanart , folder = True , isPlayable = False )
                            data = file.readline()
                            i = i + 1
                            continue
                            ...
                            plugintools.add_item( action = "pdd_findvideos" , title = '[COLOR white]' + title + ' [COLOR lightgreen][Pordede][/COLOR]', url = url_links , page = url, thumbnail = thumbnail , extra = 'regex', fanart = fanart , folder = True , isPlayable = False )
                            data = file.readline()
                            i = i + 1
                            continue                        
                        elif url.find("lolabits") >= 0:
                            plugintools.add_item( action = "" , title = '[COLOR white]' + title + ' [COLOR lightgreen][B][Lola[/B]bits][/COLOR][COLOR white][I] (' + origen + ')[/I][/COLOR]', url = url , thumbnail = thumbnail, fanart = fanart , folder = True , isPlayable = False )
                            data = file.readline()
                            i = i + 1
                            continue                        
                        ...
                        if url.find("pelisadicto") >= 0:
                            ...
                            plugintools.add_item( action = "lista_capis" , title = '[COLOR white]' + title + ' [COLOR lightgreen][B][Series[/B]FLV][/COLOR][COLOR white][I] (' + origen + ')[/I][/COLOR]', url = url , thumbnail = thumbnail, fanart = fanart , folder = True , isPlayable = False )
                            data = file.readline()
                            i = i + 1
                            continue
                        elif url.find("pordede.com") >= 0:
                            # Guardamos 'regex' como identificador de regex en la variable 'extra' y la URL de la película en 'page' para coger thumbnail y fanart
                            title_item = url.split("/peli/")[1];url_links=url.replace("/peli/","/links/view/slug/")+"/what/peli"
                            plugintools.add_item( action = "pdd_findvideos" , title = '[COLOR white]' + title + ' [COLOR lightgreen][Pordede][/COLOR]', url = url_links , thumbnail = thumbnail , page = url, extra = 'regex', fanart = fanart , folder = True , isPlayable = False )
                            data = file.readline()
                            i = i + 1
                            continue                          
                        elif url.find("lolabits") >= 0:
                ...
                if data.startswith("plugin") == True:
                    ...
                    if cat != "":
                        ...
                        title = parser_title(title)
                        data = data.strip()
                        plugintools.add_item( action = "launch_magnet" , title = '[COLOR white]' + title + ' [COLOR orangered][Magnet][/COLOR]', url = url , thumbnail = thumbnail , fanart = fanart , folder = False , isPlayable = True )
                        data = file.readline()
                        i = i + 1
                        continue
                ...
                # Youtube playlist & channel    
                    ...
                    plugintools.add_item( action = "runPlugin" , title = '[COLOR white]' + title + ' [COLOR red][You[COLOR white]Tube Playlist][/COLOR]', url = url ,  thumbnail = thumbnail , fanart = fanart , folder = True , isPlayable = False )
                    data = file.readline()
                    i = i + 1
                    continue                   
...
def search_channel(params):
    ...
    if buscar == "":
        ...
        cat = ""
        if texto == "":
            errormsg = plugintools.message("TV Ultra 7K","Por favor, introduzca el canal a buscar")
            return errormsg
...
def plx_items(params):
    ...
    while data <> "":
        ...
        if data.startswith("logo=") == True:
            ...
            plugintools.add_item(action="" , title = '[COLOR lightyellow][B][I]playlists2 / '+ title + '[/B][/I][/COLOR]', url = __playlists__ + title , thumbnail = logo , fanart = background , folder = False , isPlayable = False)
            ...
            while data <> "" :
                if data.startswith("#") == True:
                    ...
                    if url.startswith("yt_channel") == True:
                        ...
                        if url.find("allmyvideos") >= 0:
                            plugintools.add_item(action="allmyvideos" , title = title + ' [COLOR lightyellow][Allmyvideos][/COLOR]' , url = url , info_labels = datamovie , thumbnail = thumbnail , fanart = fanart , folder = False , isPlayable = True)
                            plugintools.log("URL= "+url)
                            break
                            ...
                            plugintools.add_item(action="streaminto" , title = title + ' [COLOR orange][streamin.to][/COLOR]' , url = url , thumbnail = thumbnail , fanart = fanart , folder = False , isPlayable = True)
                            plugintools.log("URL= "+url)
                            break

                        elif url.find("powvideo") >= 0:
                            plugintools.add_item(action="powvideo" , title = title + ' [COLOR orange][powvideo][/COLOR]' , url = url , thumbnail = thumbnail , fanart = fanart , folder = False , isPlayable = True)
                            plugintools.log("URL= "+url)
                            break
                            ...
                            plugintools.add_item(action="flashx" , title = title + ' [COLOR orange][Flashx][/COLOR]' , url = url , thumbnail = thumbnail , fanart = fanart , folder = False , isPlayable = True)
                            plugintools.log("URL= "+url)
                            break
                            ...
                            videoid = url.replace("https://www.youtube.com/watch?v=", "")
                            url = 'plugin://plugin.video.youtube/play/?video_id='+videoid                       
                            plugintools.runAddon( action = "play" , title = title.strip() + ' [[COLOR red]You[COLOR white]tube Video][/COLOR]', url = url , thumbnail = thumbnail , fanart = fanart , folder = False , isPlayable = False )
                            break
...
def p2p_items(params):
    ...
    # Controlamos el caso en que no haya thumbnail en el menú de TV Ultra 7K
    if thumbnail == "":
...
def contextMenu(params):
    ...
    if len_canales == 1:
        ...
        if len_canales == 2:
            ...
            selector = dialog.select('TV Ultra 7K', [tv_a, tv_b])
            ...
            selector = dialog.select('TV Ultra 7K', [tv_a, tv_b, tv_c])
            ...
            selector = dialog.select('TV Ultra 7K', [tv_a, tv_b, tv_c, tv_d])
            ...
            selector = dialog.select('TV Ultra 7K', [tv_a, tv_b, tv_c, tv_d, tv_e])
            ...
            selector = dialog.select('TV Ultra 7K', [tv_a , tv_b, tv_c, tv_d, tv_e, tv_f])
            ...
            selector = dialog.select('TV Ultra 7K', [tv_a , tv_b, tv_c, tv_d, tv_e, tv_f, tv_g])
...
def tinyurl(params):
    ...
    xbmc.executebuiltin("Notification(%s,%s,%i,%s)" % ('TV Ultra 7K', "Redireccionando enlace...", 3 , __art__+'icon.png'))
...
def cbx_reader(params):
    ...
    if url.find("mediafire") >= 0:  # ***************** MEDIAFIRE *****************
        ...
        progreso.create("TV Ultra 7K", "Iniciando descarga de [I]Mediafire[/I] en [I][B]playlists/tmp[/B][/I]\n")
        ...
        if os.path.isfile(src_cbx) is False:
            ...
            if url.endswith("cbz") == True:
                progreso.create("TV Ultra 7K", "Descargando archivo CBZ en [I][B]playlists/tmp[/B][/I]")
            elif url.endswith("cbr") == True:
                progreso.create("TV Ultra 7K", "Descargando archivo CBR en [I][B]playlists/tmp[/B][/I]")
            elif url.find("copy.com") >= 0:
                if url.find("cbr") >= 0:
                    progreso.create("TV Ultra 7K", "Descargando archivo CBR de Copy.com en [I][B]playlists/tmp[/B][/I]")
                elif url.find("cbz") >= 0:
                    progreso.create("TV Ultra 7K", "Descargando archivo CBZ de Copy.com en [I][B]playlists/tmp[/B][/I]")
            # response = urllib2.urlopen(url)
            # body = response.read()
    ...
    #xbmc.executebuiltin("Notification(%s,%s,%i,%s)" % ('TV Ultra 7K', "Descompresión fallida", 3 , __art__+'icon.png'))
